...
pyinstaller --onefile --windowed --clean --noconfirm --name "SCAA" --uac-admin --icon "icon.ico" --add-data "logo.png;." !ADDLHM! !ADDHID! --collect-all PyQt6 --collect-all numpy --collect-all psutil --collect-all pythonnet --collect-all clr_loader --collect-all certifi --collect-all OpenGL --hidden-import OpenGL.platform.win32 --exclude-module OpenGL.Tk main.py
