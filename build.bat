...
pyinstaller --onefile --windowed --clean --noconfirm --name "ServiceCom_Diag" --uac-admin --splash "logo.png" --add-data "logo.png;." !ADDLHM! !ADDHID! --collect-all PyQt6 --collect-all numpy --collect-all psutil --collect-all pythonnet --collect-all clr_loader --collect-all certifi main.py
